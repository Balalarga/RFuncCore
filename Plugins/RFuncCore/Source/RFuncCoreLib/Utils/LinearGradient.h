...
static RFUNCCORELIB_API glm::fvec4 ColorFromUint(unsigned char r,unsigned char g,
...
static RFUNCCORELIB_API glm::fvec4 ColorFromHex(unsigned int color)
{
...
class RFUNCCORELIB_API LinearGradient
{
public:
