...
class RFUNCCORELIB_API MultiDimSpace
{
public:
    ...
    size_t GetTotalPartition() const { return std::accumulate(_partition.begin(), _partition.end(), static_cast<size_t>(1), std::multiplies<size_t>()); }
